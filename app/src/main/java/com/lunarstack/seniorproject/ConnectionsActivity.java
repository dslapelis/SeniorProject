...
public abstract class ConnectionsActivity extends AppCompatActivity {
    ...
    protected void logV(String msg) {
        Log.v("CONNECTIONS ACTIVITY", msg);
    }

    @CallSuper
    protected void logD(String msg) {
        Log.d("CONNECTIONS ACTIVITY", msg);
    }

    @CallSuper
    protected void logW(String msg) {
        Log.w("CONNECTIONS ACTIVITY", msg);
    }

    @CallSuper
    protected void logW(String msg, Throwable e) {
        Log.w("CONNECTIONS ACTIVITY", msg, e);
    }

    @CallSuper
    protected void logE(String msg, Throwable e) {
        Log.e("CONNECTIONS ACTIVITY", msg, e);
    }
